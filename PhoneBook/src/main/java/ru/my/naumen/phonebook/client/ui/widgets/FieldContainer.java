package ru.my.naumen.phonebook.client.ui.widgets;
...
public class FieldContainer
  ...
  private void createWidget(String label,
    ...
    fpLabel.addStyleName(Resources.CSS.phoneBook()
                                      .fieldContainerLabel());
    Label label01 = new Label(label);
    label01.setStyleName(Resources.CSS.phoneBook()
                                      .label());
    fpLabel.add(label01);
    container.add(fpLabel);

    FlowPanel widgetContainer = new FlowPanel();
    widgetContainer.addStyleName(Resources.CSS.phoneBook()
                                              .fieldContainerWidget());
    widgetContainer.add(widget);
    container.add(widgetContainer);

    FlowPanel clearFp = new FlowPanel();
    clearFp.setStyleName(Resources.CSS.phoneBook()
                                      .clear());
